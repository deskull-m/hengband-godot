...
const std::unordered_map<std::string_view, TerrainTag> terrain_tags = {
    ...
    { "RUBBLE_ON_SHALLOW_WATER", TerrainTag::RUBBLE_ON_SHALLOW_WATER },
    { "MAGMA_VEIN_ON_SHALLOW_WATER", TerrainTag::MAGMA_VEIN_ON_SHALLOW_WATER },
    { "QUARTZ_VEIN_ON_SHALLOW_WATER", TerrainTag::QUARTZ_VEIN_ON_SHALLOW_WATER },
    { "GRANITE_ON_SHALLOW_WATER", TerrainTag::GRANITE_ON_SHALLOW_WATER },
    { "GLASS_WALL_ON_SHALLOW_WATER", TerrainTag::GLASS_WALL_ON_SHALLOW_WATER },
    { "RUBBLE_ON_DEEP_WATER", TerrainTag::RUBBLE_ON_DEEP_WATER },
    { "MAGMA_VEIN_ON_DEEP_WATER", TerrainTag::MAGMA_VEIN_ON_DEEP_WATER },
    { "QUARTZ_VEIN_ON_DEEP_WATER", TerrainTag::QUARTZ_VEIN_ON_DEEP_WATER },
    { "GRANITE_ON_DEEP_WATER", TerrainTag::GRANITE_ON_DEEP_WATER },
    { "GLASS_WALL_ON_DEEP_WATER", TerrainTag::GLASS_WALL_ON_DEEP_WATER },
};
