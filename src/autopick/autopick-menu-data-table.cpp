...
void CommandMenuData::initialize()
{
    ...
    this->menu_data.emplace_back(MN_HELP, 0, -1, EC_HELP);
    ...
    this->menu_data.emplace_back(MN_EDIT, 0, -1, -1);
    ...
    this->menu_data.emplace_back(MN_SEARCH, 0, -1, -1);
    this->menu_data.emplace_back(MN_SEARCH_STR, 1, KTRL('s'), EC_SEARCH_STR);
    this->menu_data.emplace_back(MN_SEARCH_FORW, 1, -1, EC_SEARCH_FORW);
    ...
    this->menu_data.emplace_back(MN_SEARCH_DESTROYED, 1, -1, EC_SEARCH_DESTROYED);

    this->menu_data.emplace_back(MN_MOVE, 0, -1, -1);
    ...
    this->menu_data.emplace_back(MN_INSERT, 0, -1, -1);
    this->menu_data.emplace_back(MN_INSERT_OBJECT, 1, KTRL('i'), EC_INSERT_OBJECT);
    this->menu_data.emplace_back(MN_INSERT_DESTROYED, 1, -1, EC_INSERT_DESTROYED);
    this->menu_data.emplace_back(MN_INSERT_BLOCK, 1, -1, EC_INSERT_BLOCK);
    this->menu_data.emplace_back(MN_INSERT_MACRO, 1, -1, EC_INSERT_MACRO);
    this->menu_data.emplace_back(MN_INSERT_KEYMAP, 1, -1, EC_INSERT_KEYMAP);

    this->menu_data.emplace_back(MN_ADJECTIVE_GEN, 0, -1, -1);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::UNAWARE), 1, -1, EC_IK_UNAWARE);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::UNIDENTIFIED), 1, -1, EC_IK_UNIDENTIFIED);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::IDENTIFIED), 1, -1, EC_IK_IDENTIFIED);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::STAR_IDENTIFIED), 1, -1, EC_IK_STAR_IDENTIFIED);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::COLLECTING), 1, -1, EC_OK_COLLECTING);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::ARTIFACT), 1, -1, EC_OK_ARTIFACT);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::EGO), 1, -1, EC_OK_EGO);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::GOOD), 1, -1, EC_OK_GOOD);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::NAMELESS), 1, -1, EC_OK_NAMELESS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::AVERAGE), 1, -1, EC_OK_AVERAGE);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::WORTHLESS), 1, -1, EC_OK_WORTHLESS);
    this->menu_data.emplace_back(MN_RARE, 1, -1, EC_OK_RARE);
    this->menu_data.emplace_back(MN_COMMON, 1, -1, EC_OK_COMMON);

    this->menu_data.emplace_back(MN_ADJECTIVE_SPECIAL, 0, -1, -1);
    this->menu_data.emplace_back(MN_BOOSTED, 1, -1, EC_OK_BOOSTED);
    this->menu_data.emplace_back(MN_MORE_DICE, 1, -1, EC_OK_MORE_DICE);
    this->menu_data.emplace_back(MN_MORE_BONUS, 1, -1, EC_OK_MORE_BONUS);
    this->menu_data.emplace_back(MN_WANTED, 1, -1, EC_OK_WANTED);
    this->menu_data.emplace_back(MN_UNIQUE, 1, -1, EC_OK_UNIQUE);
    this->menu_data.emplace_back(MN_HUMAN, 1, -1, EC_OK_HUMAN);
    this->menu_data.emplace_back(MN_UNREADABLE, 1, -1, EC_OK_UNREADABLE);
    this->menu_data.emplace_back(MN_REALM1, 1, -1, EC_OK_REALM1);
    this->menu_data.emplace_back(MN_REALM2, 1, -1, EC_OK_REALM2);
    this->menu_data.emplace_back(MN_FIRST, 1, -1, EC_OK_FIRST);
    this->menu_data.emplace_back(MN_SECOND, 1, -1, EC_OK_SECOND);
    this->menu_data.emplace_back(MN_THIRD, 1, -1, EC_OK_THIRD);
    this->menu_data.emplace_back(MN_FOURTH, 1, -1, EC_OK_FOURTH);

    this->menu_data.emplace_back(MN_NOUN, 0, -1, -1);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::WEAPONS), 1, -1, EC_KK_WEAPONS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::FAVORITE_WEAPONS), 1, -1, EC_KK_FAVORITE_WEAPONS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::ARMORS), 1, -1, EC_KK_ARMORS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::MISSILES), 1, -1, EC_KK_MISSILES);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::DEVICES), 1, -1, EC_KK_DEVICES);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::LIGHTS), 1, -1, EC_KK_LIGHTS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::JUNKS), 1, -1, EC_KK_JUNKS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::CORPSES), 1, -1, EC_KK_CORPSES);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::SPELLBOOKS), 1, -1, EC_KK_SPELLBOOKS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::SHIELDS), 1, -1, EC_KK_SHIELDS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::BOWS), 1, -1, EC_KK_BOWS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::RINGS), 1, -1, EC_KK_RINGS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::AMULETS), 1, -1, EC_KK_AMULETS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::SUITS), 1, -1, EC_KK_SUITS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::CLOAKS), 1, -1, EC_KK_CLOAKS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::HELMS), 1, -1, EC_KK_HELMS);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::GLOVES), 1, -1, EC_KK_GLOVES);
    this->menu_data.emplace_back(autopick_keys.at(AutopickKey::BOOTS), 1, -1, EC_KK_BOOTS);

    this->menu_data.emplace_back(MN_COMMAND_LETTER, 0, -1, -1);
    this->menu_data.emplace_back(MN_CL_AUTOPICK, 1, -1, EC_CL_AUTOPICK);
    this->menu_data.emplace_back(MN_CL_DESTROY, 1, -1, EC_CL_DESTROY);
    this->menu_data.emplace_back(MN_CL_LEAVE, 1, -1, EC_CL_LEAVE);
    this->menu_data.emplace_back(MN_CL_QUERY, 1, -1, EC_CL_QUERY);
    this->menu_data.emplace_back(MN_CL_NO_DISP, 1, -1, EC_CL_NO_DISP);

    this->menu_data.emplace_back(MN_DELETE_CHAR, -1, 0x7F, EC_DELETE_CHAR);
}

const CommandMenuDatum &CommandMenuData::get_datum(int num) const
{
