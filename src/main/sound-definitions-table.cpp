...
const std::map<SoundKind, std::string> sound_names = {
    ...
    { SoundKind::BACKSTAB_HIT, "backstab_hit" },
    { SoundKind::SURPRISE_HIT, "surprise_hit" },
    { SoundKind::FLEEING_HIT, "fleeing_hit" },
    { SoundKind::NINJA_CRITICAL_HIT, "ninja_critical_hit" },
    { SoundKind::NINJA_FATAL_HIT, "ninja_fatal_hit" },
    { SoundKind::FATAL_SPOT, "fatal_spot" },
